...
export class Game {
  ...
  draw() {
    ...
    if (this.state === 'menu') { R.drawMenu(this); return }
    if (this.state === 'hub') { R.drawHub(this); return }
    if (this.state === 'inventory') { R.drawHub(this); R.drawInventory(this); return }
    if (this.state === 'charselect') { R.drawHub(this); R.drawCharSelect(this); return }
    ...
    if (this.state === 'pause') R.drawPause(this)
    if (this.state === 'victory') R.drawVictory(this)
    if (this.state === 'end') R.drawEnd(this)
  }
